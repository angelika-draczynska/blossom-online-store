...
const HowItWorks = () => (
  ...
  <div className={styles.featureBoxes}>
    ...
    <div className={styles.image}>
      ...
      <p>They cleverly fit through the letterbox so they can be delivered if no one’s in.</p>
      </div>
      </div>
    <div className={styles.left}><div className={styles.image}>
        <img src={flowerBox3} />
      </div>
      <div className={styles.text}>
      <h4>3. They get 5 minutes of fun</h4>
      <p>Every bouquet comes with fun arranging tips so they can style theirs like a pro!</p>
      </div>
      </div>
  </div>
  </div>
